...
module.exports = require('./windows-communication.es6.js');

},{"./windows-communication.es6.js":50}],50:[function(require,module,exports){
"use strict";
...
function handleViewModelUpdate(viewModel) {
  ...
  trackerBlockingData = (0, _common.convertTrackerDataPayload)(viewModel.tabUrl, upgradedHttps, !isProtected, viewModel.rawTrackerBlockingData);
...
var fetch = function fetch(message) {
  ...
  if (message.firePixel) {
    ...
    windowsPostMessage('PrivacyDashboardFirePixelCommand', "".concat(pixelName).concat(paramString));
  }
};
...
window.chrome.webview.addEventListener('message', function (event) {
  return handleViewModelUpdate(event.data);
});
(0, _common.setupMutationObserver)(function (height) {
  windowsPostMessage('UpdateWindowSizeCommand', {
    height: height
  });
});
module.exports = {
...
},{"./common.es6":48}],51:[function(require,module,exports){
"use strict";
...
},{"../pages/popup.es6.js":64,"./localize.es6.js":52,"./mixins/index.es6.js":54,"./model.es6.js":55,"./page.es6.js":57,"./view.es6.js":59,"jquery":45}],52:[function(require,module,exports){
"use strict";
...
var supportedLocales = require('./../../../data/constants.js').supportedLocales;
...
},{"../../../locales/en/connection.json":78,"../../../locales/en/permissions.json":79,"../../../locales/en/report.json":80,"../../../locales/en/shared.json":81,"../../../locales/en/site.json":82,"../../../locales/pl/connection.json":83,"../../../locales/pl/permissions.json":84,"../../../locales/pl/report.json":85,"../../../locales/pl/shared.json":86,"../../../locales/pl/site.json":87,"./../../../data/constants.js":47,"i18next":38,"i18next-icu":37}],53:[function(require,module,exports){
"use strict";
...
},{"../../browser/communication.es6.js":49,"./mixins/index.es6.js":54,"./store.es6.js":58,"jquery":45}],56:[function(require,module,exports){
"use strict";
...
},{"../../browser/communication.es6.js":49}],61:[function(require,module,exports){
"use strict";
...
SiteCompanyList.prototype = window.$.extend({}, Parent.prototype, normalizeCompanyName, {
  ...
  _updateCompaniesList: function _updateCompaniesList() {
    ...
    this.companyList = companyNames.map(function (companyName) {
      var company = _this2.trackers[companyName];
      var displayName = company.displayName || companyName;

      if (!_this2.tab.site.whitelisted && (!_this2.tab.parentEntity || _this2.tab.parentEntity.displayName !== displayName)) {
        // Filter out unblocked 3rd party urls
        Object.keys(company.urls).forEach(function (url) {
      ...
      return {
        ...
        slug: _this2.normalizeCompanyName(displayName),
        count: company.count,
...
},{"../../browser/communication.es6.js":49,"./mixins/normalize-company-name.es6":61}],63:[function(require,module,exports){
"use strict";
...
var supportedLocales = constants.supportedLocales;
...
Site.prototype = window.$.extend({}, Parent.prototype, {
  ...
  updatePermission: function updatePermission(id, value) {
    ...
    var permissionIndex = this.permissions.findIndex(function (_ref) {
      var key = _ref.key;
      return key === id;
    });
  ...
  getUniqueTrackersCount: function getUniqueTrackersCount() {
    ...
    var count = Object.keys(this.tab.trackers).reduce(function (total, name) {
      return _this3.tab.trackers[name].count + total;
    }, 0);
    return count;
  },
  getUniqueTrackersBlockedCount: function getUniqueTrackersBlockedCount() {
    ...
    var count = Object.keys(this.tab.trackersBlocked).reduce(function (total, name) {
      var companyBlocked = _this4.tab.trackersBlocked[name]; // Don't throw a TypeError if urls are not there

      var trackersBlocked = companyBlocked.urls ? Object.keys(companyBlocked.urls) : null;

      if (trackersBlocked) {
        trackersBlocked = trackersBlocked.filter(function (url) {
          return companyBlocked.urls[url].isBlocked;
        });
  ...
  toggleWhitelist: function toggleWhitelist() {
    if (this.tab && this.tab.site) {
      ...
      var isProtected = !this.isWhitelisted;
      this.fetch({
        toggleWhitelist: {
          value: isProtected
        }
  ...
  companyNames: function companyNames() {
    ...
    if (!this.tab) return [];
    return Object.keys(this.tab.trackers).reduce(function (companyNames, companyName) {
      if (companyName === 'unknown') return companyNames;
      var company = _this5.tab.trackers[companyName];
      var urlsList = company.urls ? Object.keys(company.urls) : [];

      if (!_this5.isWhitelisted && company.urls && urlsList.every(function (url) {
        return company.urls[url].isBlocked === false;
      })) {
        return companyNames;
      }
  ...
  submitBreakageForm: function submitBreakageForm(category, description) {
    ...
    if (this.tab.consentManaged) {
      var _this$tab$consentMana = this.tab.consentManaged,
          consentManaged = _this$tab$consentMana.consentManaged,
          optoutFailed = _this$tab$consentMana.optoutFailed,
          selftestFailed = _this$tab$consentMana.selftestFailed;
      pixelParams.push({
      ...
      if (consentManaged && optoutFailed !== undefined) {
        pixelParams.push({
          consentOptoutFailed: optoutFailed ? '1' : '0'
        });
      }

      if (consentManaged && selftestFailed !== undefined) {
        pixelParams.push({
          consentSelftestFailed: selftestFailed ? '1' : '0'
        });
      }
    }
...
},{"../../../data/constants":47,"../../browser/communication.es6.js":49}],64:[function(require,module,exports){
"use strict";
...
},{"./../models/background-message.es6.js":60,"./../models/site.es6.js":63,"./../templates/site.es6.js":72,"./../views/site.es6.js":75}],65:[function(require,module,exports){
"use strict";
...
},{"./shared/hero.es6.js":67,"bel":29}],66:[function(require,module,exports){
"use strict";
...
function getKeyUsage(key) {
  ...
  var keyUsage = Object.keys(capabilities).reduce(function (usage, capability) {
...
function renderCertificateDetails(model) {
  ...
  return bel(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n        <div class=\"page-connection__certificate\">\n            <div class=\"page-connection__certificate-details border--bottom-light--inner\">\n                <h3>", "</h3>\n                <div>\n                    <span>", "</span>\n                    <span class=\"page-connection__certificate-value\">", "</span>\n                </div>\n                ", "\n            </div>\n            <div class=\"page-connection__certificate-details\">\n                <h3>", "</h3>\n                <div>\n                    <span>", "</span>\n                    <span class=\"page-connection__certificate-value\">", "</span>\n                </div>\n                <div>\n                    <span>", "</span>\n                    <span class=\"page-connection__certificate-value\">", " bits</span>\n                </div>\n                ", "\n                <div>\n                    <span>", "</span>\n                    <span class=\"page-connection__certificate-value\">", "</span>\n                </div>\n                ", "\n            </div>\n        </div>\n    "])), i18n.t('connection:certificateDetail.title'), i18n.t('connection:commonName.title'), certificate.commonName, renderCertificateSummary(certificate), i18n.t('connection:publicKey.title'), i18n.t('connection:algorithm.title'), certificate.publicKey.type, i18n.t('connection:keySize.title'), certificate.publicKey.bitSize, renderCertificateEffectiveSize(certificate), i18n.t('connection:usage.title'), getKeyUsage(certificate.publicKey), renderCertificateIsPermanent(certificate));
}
...
},{"./shared/hero.es6.js":67,"bel":29}],67:[function(require,module,exports){
"use strict";
...
},{"bel":29}],68:[function(require,module,exports){
"use strict";
...
var _require = require('./utils.es6.js'),
    isSiteWithOnlyOwnTrackers = _require.isSiteWithOnlyOwnTrackers;

module.exports = function (site) {
  var isWhitelisted = site.isWhitelisted,
      totalTrackerNetworksCount = site.totalTrackerNetworksCount;
...
},{"./utils.es6.js":71,"bel":29}],70:[function(require,module,exports){
"use strict";
...
module.exports = function (site, isMajorNetworksCount) {
  ...
  var trackerCount = site.isWhitelisted ? site.trackersCount : site.trackersBlockedCount || 0;

  if (isMajorNetworksCount) {
    trackerCount = site.majorTrackerNetworksCount;
  }

  var finalText = i18n.t('site:trackerNetworksDesc.title', {
...
},{"./utils.es6":71,"bel":29}],71:[function(require,module,exports){
"use strict";
...
var renderUpdatingSpinner = function renderUpdatingSpinner() {
  return bel(_templateObject || (_templateObject = _taggedTemplateLiteral(["<img src=\"../img/spinner.svg\" style=\"height: 18px; width: 18px;\" alt=\"", "\" />"])), i18n.t('site:updatingProtectionList.title'));
};

module.exports = function () {
  var protectionStatus = this.model.isWhitelisted ? bel(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["", ""])), raw(i18n.t('site:protectionsDisabled.title'))) : bel(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["", ""])), raw(i18n.t('site:protectionsEnabled.title')));
...
},{"../models/mixins/normalize-company-name.es6.js":61,"./shared/toggle-button.es6.js":68,"./shared/tracker-network-icon.es6.js":69,"./shared/tracker-networks-text.es6.js":70,"./shared/utils.es6.js":71,"bel":29,"bel/raw":30}],73:[function(require,module,exports){
"use strict";
...
var _require = require('./shared/utils.es6.js'),
    isSiteWithOnlyOwnTrackers = _require.isSiteWithOnlyOwnTrackers,
    isSameEntity = _require.isSameEntity,
...
module.exports = function () {
  ...
  return bel(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["<div class=\"tracker-networks site-info card\">\n        <div class=\"js-tracker-networks-hero\">\n            ", "\n        </div>\n        <div class=\"tracker-networks__explainer text--center\">\n            ", "\n        </div>\n        <div class=\"tracker-networks__details padded js-tracker-networks-details\">\n            ", "\n        </div>\n    </div>"])), renderHero(this.model.site), renderSummary(this.model), renderTrackerDetails(this.model));
};
...
function renderSummary(model) {
  if (isSiteWithOnlyOwnTrackers(model.site)) {
    ...
    var name = ((_model$tab$parentEnti = model.tab.parentEntity) === null || _model$tab$parentEnti === void 0 ? void 0 : _model$tab$parentEnti.displayName) || model.tab.site.domain;
    return i18n.t('site:firstPartyDesc.title', {
      companyName: name
    });
  }
...
function trackerListWrapper(heading, contents) {
  ...
  return bel(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["\n        <ol class=\"default-list site-info__trackers__company-list\" aria-label=\"List of tracker networks\">\n            ", "\n            ", "\n        </ol>\n    "])), heading ? bel(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["<li class=\"tracker-list-header border-light--bottom--inner border-light--top--inner\">", "</li>"])), heading) : '', contents);
}

function renderCompanyTrackers(model) {
  return function (c, i, companyList) {
    if (c.name && c.name === 'unknown') {
      c.name = "(".concat(i18n.t('site:trackerNetworkUnknown.title'), ")");
    }

    var isLast = companyList.length - 1 === i;
    return bel(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["<li class=\"site-info__trackers__company-list-item ", "\">\n            <h1 title=\"", "\" class=\"site-info__domain block\">\n                <span class=\"site-info__tracker__icon ", " color-", " ", "\"></span>\n                ", "\n            </h1>\n            <ol class=\"default-list site-info__trackers__company-list__url-list\" aria-label=\"", "\">\n                ", "\n            </ol>\n        </li>"])), isLast ? '' : 'border-light--bottom--inner', c.name, c.slug[0].toUpperCase(), getColorId(c.slug), c.slug, c.displayName, i18n.t('site:trackerDomainsForCompany.title', {
      companyName: c.name
    }), c.urlsList.map(function (url) {
      // find first matching category from our list of allowed display categories
      var category = '';

      if (c.urls[url] && c.urls[url].categories) {
        Object.keys(displayCategories).some(function (displayCat) {
      ...
      return bel(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["<li>\n                        <div class=\"url\">", "</div>\n                        <div class=\"category\">", "</div>\n                    </li>"])), url, i18n.t(category));
    }));
  };
}

function reduceCompanyListByUrl(companyList, filterBy) {
  return companyList.reduce(function (group, company) {
    var filteredUrlsList = company.urlsList.filter(function (url) {
      return filterBy(company, url);
    });
    if (filteredUrlsList.length === 0) return group;
    var filteredUrls = filteredUrlsList.reduce(function (group, url) {
      return Object.assign(group, _defineProperty({}, url, company.urls[url]));
    }, {});
    var blockedCompany = Object.assign({}, company, {
      urls: filteredUrls,
      urlsList: filteredUrlsList
    });
...
function renderTrackerDetails(model) {
  ...
  var blockedCompanies = reduceCompanyListByUrl(companyList, function (company, url) {
    var sameEntity = isSameEntity(company, model.tab.parentEntity);
    return model.site.isWhitelisted ? !sameEntity : !sameEntity && company.urls[url].isBlocked;
  });
  var unblockedCompanies = reduceCompanyListByUrl(companyList, function (company, url) {
    return isSameEntity(company, model.tab.parentEntity);
  });
  var count = model.site.isWhitelisted ? model.site.trackersCount : model.site.trackersBlockedCount;
  return bel(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["\n        <div>\n            ", "\n            ", "\n        </div>\n    "])), trackerListWrapper(i18n.t('site:trackerOwnedByThisSite.title'), unblockedCompanies.map(renderCompanyTrackers(model))), trackerListWrapper(i18n.t('site:trackerCountForDomain.title', {
    trackerCount: count,
    blocked: !model.site.isWhitelisted,
    domain: model.domain
  }), blockedCompanies.map(renderCompanyTrackers(model))));
}

},{"./../../../data/constants.js":47,"./shared/hero.es6.js":67,"./shared/tracker-network-icon.es6.js":69,"./shared/utils.es6.js":71,"bel":29}],74:[function(require,module,exports){
"use strict";
...
},{"./../templates/breakage-form.es6.js":65,"./../templates/page-connection.es6.js":66,"./../templates/tracker-networks.es6.js":73,"./../views/breakage-form.es6.js":74,"./../views/tracker-networks.es6.js":77}],76:[function(require,module,exports){
"use strict";
...
TrackerNetworks.prototype = window.$.extend({}, ParentSlidingSubview.prototype, {
  ...
  _rerender: function _rerender(e) {
    if (e && e.change) {
      if (e.change.attribute === 'isaMajorTrackingNetwork' || e.change.attribute === 'isWhitelisted' || e.change.attribute === 'totalTrackerNetworksCount') {
...
},{"./../models/site-company-list.es6.js":62,"./../models/site.es6.js":63,"./../templates/shared/hero.es6.js":67,"./../templates/shared/tracker-network-icon.es6.js":69,"./sliding-subview.es6.js":76}],78:[function(require,module,exports){
module.exports={
    "smartling": {
        "string_format" : "icu",
        "translate_paths": [{
    ...
    "insecureConnectionDesc": {
        "title": "This page doesn't allow for a secure connection. Others may be able to intercept sensitive information you send on this page.",
    ...
    "secureConnectionDesc": {
        "title": "This page uses a secure connection, which protects information you send while in transit.",
...
module.exports={
    ...
    "reportsAreAnonymousDesc": {
        "title": "Reports sent to DuckDuckGo are 100% anonymous and only include your selection above, your optional description, the URL, and a list of trackers we found on the site.",
    ...
    "yourReportWillHelpDesc": {
        "title": "Your report will help improve the browser and make the experience better for other people.",
...
module.exports={
    ...
    "protectionsDisabled": {
        "title": "Protections have been <b>DISABLED</b>",
        "note": "Headline when privacy protections are disabled"
    },
    "protectionsEnabled": {
        "title": "Protections are <b>ENABLED</b> for this site",
        "note": "Headline when privacy protections are enabled"
    },
    "connectionDescriptionUnencrypted": {
        "title": "Others may be able to intercept sensitive information you send on this page.",
        "note": "Shown when the connection is not encrypted (HTTP instead of HTTPS)"
    },
    "connectionDescriptionUpgraded": {
        "title": "We upgraded the connection on this page to protect information you send in transit.",
    ...
    "connectionDescriptionEncrypted": {
        "title": "The connection on this page is secure to protect information you send in transit.",
    ...
    "trackerNetworksSummaryOwn": {
        "title": "We only found trackers owned by {name}, which we didn't block.",
        "note": "We found but did not block trackers from company named"
    },
    "trackerNetworksSummaryOther": {
        "title": "We {isWhitelisted, select, true {found} other {blocked}} {displayCount} known {displayCount, plural, =1 {tracker} other {trackers}} from {companyCount} {companyCount, plural, one {company} other {companies}} on this page.",
    ...
    "protectionsAreDisabled": {
        "title": "Protections are DISABLED",
    ...
    "foundCompanyNamesList": {
        "title": "We found {companyCount, plural, =0 {some companies} =1 {{firstCompany}} =2 {{firstCompany} and {secondCompany}} other {{firstCompany}, {secondCompany} and others}} tracking and profiling you on this page.",
    ...
    "majorTrackingNetworkDesc": {
        "title": "{companyDisplayName} (owner of {domain})\ntracks you across {companyPrevalence}% of top sites.\nWe can’t block them on sites they own, but we can on other pages.",
    ...
    "trackersBlocked": {
        "title": "Who We Blocked",
        "note": "Title for the list of companies that we blocked"
    },
    "trackersBlockedDesc": {
        "title": "We blocked {companyCount, plural, =0 {some companies} =1 {{firstCompany}} =2 {{firstCompany} and {secondCompany}} other {{firstCompany}, {secondCompany} and others}} from trying to track you.",
    ...
    "connectionNotSecure": {
        "title": "Connection Could Not Be Secured",
...
module.exports={
  ...
  "certificateDetail" : {
    "title" : "[S~écúr~ítý C~értí~fícá~té Dé~táíl]",
    "note" : "Header for section that contains the SSL certificate details"
  },
  "commonName" : {
    "title" : "[C~ómm~óñ Ñ~ámé]",
    "note" : "The Common Name for an SSL certificate"
  },
  "publicKey" : {
    "title" : "[P~úblí~c Kéý]",
  ...
  "effectiveSize" : {
    "title" : "[É~fféc~tívé ~Sízé]",
    "note" : "Effective size of encryption key for an SSL certificate"
  },
  "certificateNotFound" : {
    "title" : "[C~ért~ífíc~áté ñ~ót fó~úñd]",
    "note" : "When the connection is not encrypted (ie. http) we do not have any certificate details to show"
  },
  "certificateForDomain" : {
    "title" : "[C~értí~fícá~té fó~r {domain}]",
    "note" : "Header for certificate details for a given domain"
  },
  "insecureConnectionDesc" : {
    "title" : "[T~hís p~ágé d~óésñ~'t ál~lów f~ór á s~écúr~é cóñ~ñéct~íóñ. ~Óthé~rs má~ý bé á~blé t~ó íñt~ércé~pt sé~ñsít~ívé í~ñfór~mátí~óñ ýó~ú séñ~d óñ t~hís p~ágé.]",
    "note" : "Shown we connection is not encrypted"
  },
  "upgradedConnectionDesc" : {
    "title" : "[W~é úp~grád~éd th~é cóñ~ñéct~íóñ ó~ñ thí~s pág~é tó p~róté~ct íñ~fórm~átíó~ñ ýóú ~séñd ~whíl~é íñ t~ráñs~ít.]",
    "note" : "Shown when we successfully upgrade a connection from an insecure one to a secure connection"
  },
  "secureConnectionDesc" : {
    "title" : "[T~hís p~ágé ú~sés á ~sécú~ré có~ññéc~tíóñ~, whí~ch pr~ótéc~ts íñ~fórm~átíó~ñ ýóú ~séñd ~whíl~é íñ t~ráñs~ít.]",
    "note" : "Shown when the user navigated directly to a secure connection"
  }
}
...
module.exports={
  ...
  "grant" : {
    "title" : "[Á~lwá~ýs ál~lów]",
    "note" : "A permission setting that allows the website to always use this permission without asking"
  },
  "deny" : {
    "title" : "[Á~lwá~ýs d~éñý]",
    "note" : "A permission setting that always blocks the website from using this permission"
  }
}
...
module.exports={
  ...
  "selectTheOptionDesc" : {
    "title" : "[S~éléc~t thé ~óptí~óñ th~át bé~st dé~scrí~bés t~hé pr~óblé~m ýóú ~éxpé~ríéñ~céd.]",
    "note" : "The user will see this UI when they're running into issues with a given website, that we may be causing"
  },
  "pickYourIssueFromTheList" : {
    "title" : "[P~íck ~ýóúr ~íssú~é fró~m thé ~líst~...]",
    "note" : "Asks the user to pick a specific list from the pulldown"
  },
  "videos" : {
    "title" : "[V~ídé~ó díd~ñ't p~láý]",
    "note" : "User is reporting this page because a video didn't play"
  },
  "images" : {
    "title" : "[Í~mágé~s díd~ñ't l~óád]",
    "note" : "User is reporting this page because one or more images did not load"
  },
  "comments" : {
    "title" : "[C~ómm~éñts ~díd~ñ't l~óád]",
    "note" : "User is reporting this page because one or more comments did not load"
  },
  "content" : {
    "title" : "[C~óñté~ñt ís ~míss~íñg]",
    "note" : "User is reporting this page because some other type of content did not load"
  },
  "links" : {
    "title" : "[L~íñk~s ór b~úttó~ñs dó~ñ't w~órk]",
    "note" : "User is reporting this page because one or more links or buttons did not work when clicked"
  },
  "login" : {
    "title" : "[Í ~cáñ'~t síg~ñ íñ]",
    "note" : "User is reporting this page because they are unable to log into the website"
  },
  "paywall" : {
    "title" : "[T~hé s~íté á~skéd ~mé tó ~dísá~blé]",
    "note" : "User is reporting this page asked them to disable their privacy or ad blocking extension"
  },
  "other" : {
    "title" : "[S~ómét~híñg ~élsé]",
    "note" : "User is reporting this page because of some other reason than the ones we listed"
  },
  "reportBrokenSite" : {
    "title" : "[R~épór~t Bró~kéñ S~íté]",
    "note" : "Title for reporting broken website view"
  },
  "tellUsMoreDesc" : {
    "title" : "[Í~f ýó~ú'd l~íké, ~téll ~ús áb~óút t~hé pr~óblé~m ýóú ~éxpé~ríéñ~céd]",
    "note" : "A hint for a text box that lets user enter free text to describe their problem"
  },
  "sendReport" : {
    "title" : "[S~éñd ~rép~órt]",
  ...
  "reportsAreAnonymousDesc" : {
    "title" : "[R~épó~rts s~éñt t~ó Dúc~kDúc~kGó á~ré 10~0% áñ~óñým~óús á~ñd óñ~lý íñ~clúd~é ýóú~r sél~éctí~óñ áb~óvé~, ýóú~r ópt~íóñá~l dés~críp~tíóñ~, thé ~ÚRL, ~áñd á ~líst ~óf tr~ácké~rs wé ~fóúñ~d óñ t~hé sí~té.]",
    "note" : "A small disclaimer at the bottom of the view describing what is included in the report"
  },
  "thankYou" : {
    "title" : "[T~háñk ~ýóú¡]",
  ...
  "yourReportWillHelpDesc" : {
    "title" : "[Ý~óúr r~épór~t wíl~l hél~p ímp~róvé ~thé b~róws~ér áñ~d mák~é thé ~éxpé~ríéñ~cé bé~ttér ~fór ó~thér ~péóp~lé.]",
    "note" : "Body that the user sees upon submitting the report"
  }
}
...
module.exports={
  ...
  "updatingProtectionList" : {
    "title" : "[Ú~pdá~tíñg ~prót~éct~íóñ l~íst]",
    "note" : "Message shown while updating the list of protections"
  },
  "protectionsDisabled" : {
    "title" : "[P~rót~éctí~óñs h~ávé b~ééñ <b>D~ÍSÁB~LÉD</b>]",
    "note" : "Headline when privacy protections are disabled"
  },
  "protectionsEnabled" : {
    "title" : "[P~róté~ctíó~ñs ár~é <b>ÉÑÁ~BLÉD</b> ~fór t~hís s~íté]",
    "note" : "Headline when privacy protections are enabled"
  },
  "connectionDescriptionUnencrypted" : {
    "title" : "[Ó~thér~s máý ~bé áb~lé tó ~íñté~rcép~t séñ~sítí~vé íñ~fórm~átíó~ñ ýóú ~séñd ~óñ th~ís pá~gé.]",
    "note" : "Shown when the connection is not encrypted (HTTP instead of HTTPS)"
  },
  "connectionDescriptionUpgraded" : {
    "title" : "[W~é úp~grád~éd th~é cóñ~ñéct~íóñ ó~ñ thí~s pág~é tó p~rót~éct í~ñfór~mátí~óñ ýó~ú séñ~d íñ t~ráñs~ít.]",
    "note" : "Shown when the connection has been upgraded from unencrypted to encrypted (HTTP to HTTPS)"
  },
  "connectionDescriptionEncrypted" : {
    "title" : "[T~hé có~ññéc~tíóñ ~óñ th~ís pá~gé ís ~sécú~ré tó ~prót~éct í~ñfór~mátí~óñ ýó~ú séñ~d íñ t~ráñs~ít.]",
    "note" : "Shown when the connection is encrypted (HTTPS not HTTP)"
  },
  "trackerNetworksSummaryNone" : {
    "title" : "[W~é dí~dñ't ~fíñd ~áñý c~ómpá~ñíés ~trýí~ñg tó ~trác~k ýóú ~óñ th~ís pá~gé.]",
    "note" : "We did not find any trackers on this page"
  },
  "trackerNetworksSummaryOwn" : {
    "title" : "[W~é óñl~ý fóú~ñd tr~ácké~rs ów~ñéd b~ý {name}, wh~ích w~é díd~ñ't b~lóck~.]",
    "note" : "We found but did not block trackers from company named"
  },
  "trackerNetworksSummaryOther" : {
    "title" : "[W~é {~ísWh~ítél~ísté~d, sé~léct~, trú~é {f~óúñd~} ót~hér {~{bló~ckéd~}} ~{dí~splá~ýCóú~ñt} ~kñów~ñ {d~íspl~áýCó~úñt, ~plúr~ál, =~1 {t~ráck~ér}~} óth~ér {~trác~kérs~}} ~fróm ~{có~mpáñ~ýCóú~ñt} ~{có~mpáñ~ýCóú~ñt, p~lúrá~l, óñ~é {c~ómpá~ñý} ~óthé~r {c~ómpá~ñíés~}} ~óñ th~ís pá~gé.]",
    "note" : "This summarizes the number of trackers that we either blocked or did not block (depending on the protection setting for this site)"
  },
  "websiteNotWorkingQ" : {
    "title" : "[W~ébsí~té ñó~t wór~kíñg ~ás éx~péct~éd¿]",
    "note" : "Call to action for user to click if they are having issues with this web page"
  },
  "takePrecautions" : {
    "title" : "[T~áké ~Préc~áútí~óñs]",
    "note" : "Title shown when the page is unencrypted"
  },
  "protectionsAreDisabled" : {
    "title" : "[P~rót~éctí~óñs á~ré D~ÍSÁB~LÉD]",
    "note" : "Shown when user has disabled protections for this site (or they have been programatically disabled)"
  },
  "foundCompanyNamesList" : {
    "title" : "{companyCount, plural, =0 {[W~é fó~úñd s~ómé c~ómpá~ñíés ~trác~kíñg ~áñd ~próf~ílíñ~g ýóú ~óñ th~ís pá~gé.]} =2 {[W~é fó~úñd {firstCompany} á~ñd {secondCompany} tr~áckí~ñg áñ~d pró~fíl~íñg ý~óú óñ ~thís ~págé~.]} one {[ONE: W~é fóú~ñd {firstCompany} tr~áckí~ñg áñ~d pró~fílí~ñg ýó~ú óñ t~hís p~ágé.]} other {[OTHER: W~é fóú~ñd {firstCompany}, {secondCompany} á~ñd ót~hérs ~trác~kíñg ~áñd p~rófí~líñg ~ýóú ó~ñ thí~s pág~é.]}}",
    "note" : "Returns a string in the form of 'We found CompanyA, CompanyB and others tracking and profiling you on this page.'"
  },
  "majorTrackerNetwork" : {
    "title" : "[T~rác~kér Ñ~étw~órk]",
    "note" : "Tracker network is a group of trackers, usually in the form of a company name, that track users across websites"
  },
  "majorTrackingNetworkDesc" : {
    "title" : "[{companyDisplayName} (~ówñé~r óf {domain})\n~trác~ks ýó~ú ácr~óss {companyPrevalence}% ~óf tó~p sít~és.\nW~é cáñ~’t bl~óck t~hém ó~ñ sít~és th~éý ów~ñ, bú~t wé c~áñ óñ ~óthé~r pág~és.]",
    "note" : "When visiting a site that is owned by a major tracking company, we cannot block their trackers so we warn the user.  Ex. Google (owner of news.google.com) tracks you across 79% of top sites.... etc"
  },
  "noActivityToReport" : {
    "title" : "[Ñ~ó Ác~tíví~tý t~ó Rép~órt]",
    "note" : "Title when we did not find any trackers on this page"
  },
  "trackersBlocked" : {
    "title" : "[W~hó Wé ~Blóc~kéd]",
    "note" : "Title for the list of companies that we blocked"
  },
  "trackersBlockedDesc" : {
    "title" : "{companyCount, plural, =0 {[W~é bló~ckéd ~sómé ~cómp~áñíé~s fró~m trý~íñg t~ó trá~ck áñ~d pró~fílé ~ýóú.]} =2 {[W~é bló~ckéd {firstCompany} ~áñd {secondCompany} f~róm t~rýíñ~g tó t~ráck ~áñd p~rófí~lé ýó~ú.]} one {[ONE: W~é bl~ócké~d {firstCompany} fró~m trý~íñg t~ó trá~ck áñ~d pró~fílé ~ýóú.]} other {[OTHER: W~é bló~ckéd {firstCompany}~, {secondCompany} áñd ~óthé~rs fr~óm tr~ýíñg ~tó tr~áck á~ñd pr~ófíl~é ýóú~.]}}",
    "note" : "Returns a string in the form of 'We blocked CompanyA and CompanyB from trying to track you.'"
  },
  "cookiesMinimized" : {
    "title" : "[C~óókí~és Mí~ñímí~zéd]",
    "note" : "Title for when we have set the cookie privacy settings on this website to maximize privacy"
  },
  "cookiesMinimizedDesc" : {
    "title" : "[W~é sét ~ýóúr ~cóók~íé pr~éfér~éñcé~s tó m~áxím~ízé p~rívá~cý áñ~d cló~séd t~hé có~ñséñ~t póp~-úp.]",
    "note" : "Description for when we have set the cookie privacy settings on this website to maximize privacy"
  },
  "connectionSecure" : {
    "title" : "[C~óññ~éctí~óñ Í~s Séc~úré]",
    "note" : "The connection to the website is secure (HTTPS)"
  },
  "connectionNotSecure" : {
    "title" : "[C~óññ~éctí~óñ Có~úld Ñ~ót Bé ~Sécú~réd]",
    "note" : "The connection is not secure (HTTP)"
  },
  "trackerNetworksDesc" : {
    "title" : "{blocked, select, true {{majorNetwork, select, true {{trackerCount, plural, one {[ONE: {trackerCount} M~ájór ~Trác~kér Ñ~étwó~rk Bl~ócké~d]} other {[OTHER: {trackerCount} M~ájó~r Trá~ckér ~Ñétw~órk~s Bló~ckéd]}}} other {{trackerCount, plural, one {[ONE: {trackerCount} T~ráck~ér Bl~ócké~d]} other {[OTHER: {trackerCount} T~rác~kérs ~Bló~ckéd]}}}}} other {{majorNetwork, select, true {{trackerCount, plural, one {[ONE: {trackerCount} M~ájó~r Trá~ckér ~Ñétw~órk F~óúñd]} other {[OTHER: {trackerCount} M~ájór ~Trác~kér Ñ~étwó~rks F~óúñd]}}} other {{trackerCount, plural, one {[ONE: {trackerCount} T~rác~kér F~óúñd]} other {[OTHER: {trackerCount} T~ráck~érs F~óúñd]}}}}}}",
    "note" : "This describes how many trackers (or major tracking networks) were blocked (or found if protections are disabled).  Ex: 9 Trackers Blocked"
  },
  "firstPartyDesc" : {
    "title" : "[{companyName} ó~wñs ~thís ~síté ~áñd t~hé kñ~ówñ t~ráck~érs f~óúñd ~óñ t~hís p~ágé, ~só wé ~dídñ~'t bl~óck t~hém.]",
    "note" : "When trackers detected belong to companyName, we can't block them on a site that company owns"
  },
  "trackersFoundForAllowlisted" : {
    "title" : "[T~rác~kérs ~hélp ~cómp~áñíé~s pró~fílé ~ýóú. ~Wé fó~úñd t~hésé ~cóm~páñí~és mó~ñító~ríñg ~ýóúr ~áctí~vítý ~óñ th~ís pá~gé.]",
    "note" : "This header for the list of tracker companies is shown when a site has protections disabled"
  },
  "trackersFoundAndBlocked" : {
    "title" : "[T~ráck~érs h~élp c~ómpá~ñíés ~próf~ílé ý~óú. W~é bló~ckéd ~thés~é cóm~páñí~és fr~óm mó~ñító~ríñg ~ýóúr ~áctí~vítý ~óñ th~ís pá~gé.]",
    "note" : "This header for the list of tracker companies is shown when a site has protections enabled"
  },
  "trackerNetworkUnknown" : {
    "title" : "[T~ráck~ér ñé~twór~k úñk~ñówñ]",
    "note" : "Shown when we don't have a company name for a given tracker"
  },
  "trackerDomainsForCompany" : {
    "title" : "[T~ráck~ér dó~máíñ~s fór {companyName}]",
    "note" : "Title for the list of tracker domains detected from a given company"
  },
  "zeroTrackersFound" : {
    "title" : "[0 ~Trá~ckér~s Fó~úñd]",
    "note" : "We did not find any trackers on this page"
  },
  "trackerOwnedByThisSite" : {
    "title" : "[T~ráck~érs Ó~wñéd ~bý Th~ís Sí~té (Á~llów~éd)]",
    "note" : "Trackers owned by this site are not blocked"
  },
  "trackerCountForDomain" : {
    "title" : "{blocked, select, true {{trackerCount, plural, one {[ONE: {trackerCount} T~rác~kér B~lóck~éd ó~ñ {domain}]} other {[OTHER: {trackerCount} T~rác~kérs ~Blóc~kéd ó~ñ {domain}]}}} other {{trackerCount, plural, one {[ONE: {trackerCount} T~ráck~ér Fó~úñd ó~ñ {domain}]} other {[OTHER: {trackerCount} T~ráck~érs F~óúñd ~óñ {domain}]}}}}",
    "note" : "For a given domain, the count of trackers either blocked or just detected (found).  Ex 4 Trackers Blocked"
  },
  "analyticsCategory" : {
    "title" : "[Á~ñálý~tícs]",
  ...
  "advertisingCategory" : {
    "title" : "[Á~dvé~rtís~íñg]",
    "note" : "Used to describe the type of tracker, in this case one that is used for advertising"
  },
  "socialCategory" : {
    "title" : "[S~ócíá~l Ñét~wórk]",
    "note" : "Used to describe the type of tracker, in this case one that is used by one of the popular social networksr"
  }
}
